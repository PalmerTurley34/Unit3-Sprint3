...
from web_app.services.twitter_service import api
...
def get_user(screen_name=None):
    ...
    statuses = api.user_timeline(screen_name, tweet_mode="extended", count=150, exclude_replies=True, include_rts=True)
